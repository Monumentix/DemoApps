...
<div class="row">
  <div class="col-sm-12">
    <?php if(!(empty($id))) : ?>
      <h2 class="endpoint">(/v1/public/events/{eventId}/comics) : <small>Fetches lists of comics which take place during a specific event, with optional filters. </small></h2>
    <?php endif; ?>
    </div>
</div>
