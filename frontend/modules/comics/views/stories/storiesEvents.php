...
$this->title = 'Events For : '.(!(empty($storiesResponse['title'])) ? $storiesResponse['title'] :  ' No results ' );
...
<div class="comics-stories-events">

<div class="row">
  <div class="col-sm-12">
    <?php if(!(empty($id))) : ?>
      <h2 class="endpoint">(/v1/public/stories/{storyId}/events) : <small>Fetches lists of events in which a specific story appears, with optional filters.</small></h2>
    <?php endif; ?>
    </div>
</div>
