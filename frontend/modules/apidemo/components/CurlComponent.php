...
namespace app\modules\apidemo\components;
...
class CurlComponent extends Component{
    ...
    public $path = 'http://sandbox.api.shopping.com/publisher/3.0/rest/';
    public $auth = '&apiKey=78b0db8a-0ee1-4939-a2f9-d3cd95ec0fcc&trackingId=7000610';

    // ############################################### class methods // ##############################################

    public function search($string, $pageNumber = null){
      if(!is_null($pageNumber)){
        $pageNumber = '&pageNumber='.$pageNumber;
      }
      $url = $this->path.'GeneralSearch?keyword='.$string.$this->auth.$pageNumber;
    ...
    public function getCategory($catId, $pageNumber = null){
      if(!is_null($pageNumber)){
        ...
        $url = $this->path.'CategoryTree?categoryId='.$catId.$this->auth;
      }
